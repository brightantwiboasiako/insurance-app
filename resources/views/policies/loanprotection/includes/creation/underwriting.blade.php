<div class="step-pane" id="underwriting">
    ...
    <div class="col-md-8">
        ...
        <div class="form-group col-md-2">
            <select class="form-control validate[required]" v-model="newPolicy.underwriting.cancer" name="cancer">
        ...
        <div class="form-group col-md-2">
            <select class="form-control validate[required]" v-model="newPolicy.underwriting.hiv" name="hiv">
                <option value="No">No</option>
                <option value="Yes">Yes</option>
            </select>
        </div>
        ...
        <div class="form-group col-md-2">
            <select class="form-control validate[required]" v-model="newPolicy.underwriting.illness" name="illness">
                <option value="No">No</option>
                <option value="Yes">Yes</option>
            </select>
        </div>
        ...
        <div class="form-group col-md-3">
            <input type="text" v-model="newPolicy.underwriting.declined_proposal" name="declined_proposal"
        ...
        <div class="form-group col-md-12">
            <textarea class="form-control validate" v-model="newPolicy.underwriting.doctor_consult"
    ...
    <div class="col-md-4">
        ...
        <div class="form-group col-md-9">
            <input type="text" class="form-control validate[required]"
                   v-model="newPolicy.underwriting.height" name="height"/>
        </div>
        <div class="col-md-3">
            <label>
                <h4>Weight(kg)</h4>
        ...
        <div class="form-group col-md-9">
            <input type="text" class="form-control validate[required]"
                   v-model="newPolicy.underwriting.weight" name="weight"/>
        </div>
        <div class="col-md-7">
            <label>
        ...
        <div class="form-group col-md-5">
            <select class="form-control validate[required]" name="good_health"
                    v-model="newPolicy.underwriting.good_health">
                <option value="No">No</option>
                <option value="Yes">Yes</option>
            </select>
        </div>
