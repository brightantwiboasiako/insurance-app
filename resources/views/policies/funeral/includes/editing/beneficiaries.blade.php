<div class="step-pane" id="beneficiaries">
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-md-3">
            <input class="form-control" v-model="policy.trustee.name"
                   placeholder="Name" name="trustee_name"/>
        </div>
        <div class="form-group col-md-1">
            <input class="form-control" v-model="policy.trustee.age"
                   name="trustee_age" placeholder="Age"/>
        </div>
        <div class="form-group col-md-2">
            <select class="form-control" name="trustee_gender" v-model="policy.trustee.gender">
                <option value="Male">Male</option>
                <option value="Female">Female</option>
            </select>
        </div>
        <div class="form-group col-md-2">
            <input class="form-control" v-model="policy.trustee.relationship"
                   name="trustee_relationship" placeholder="Relationship"/>
        </div>
        <div class="form-group col-md-2">
            <input class="form-control" v-model="policy.trustee.phone_number"
                   name="trustee_phone" placeholder="Phone Number"/>
        </div>
    </div>
    <div class="col-md-12" v-if="policy.beneficiaries.length > 0">
        <div class="col-md-12">
        ...
        <div class="col-md-12 table-responsive">
            <table class="table table-stripped">
                ...
                <tbody>
                <tr v-for="(key, beneficiary) in policy.beneficiaries">
                    <td>@{{ (key + 1) }}</td>
